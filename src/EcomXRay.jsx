...
export default function App() {
  ...
  const [legalModal,setLegalModal]=useState(null); // null | "cgv" | "privacy"
  ...
  return (
    <LangCtx.Provider value={{lang,setLang}}>
      <div style={{height:"100vh",display:"flex",flexDirection:"column",background:C.bg,overflow:"hidden"}} dir={dir}>
        ...
        {/* Footer legal links */}
        {storeTab==="shop"&&(
          <div style={{position:"fixed",bottom:cookieAccepted?8:70,left:16,zIndex:50,display:"flex",gap:10}}>
            <button onClick={()=>setLegalModal("cgv")} style={{background:"rgba(44,31,14,0.7)",border:"none",borderRadius:4,padding:"4px 10px",color:"rgba(250,250,247,0.6)",fontSize:8,cursor:"pointer",fontFamily:"'JetBrains Mono',monospace",backdropFilter:"blur(4px)"}}>CGV</button>
            <button onClick={()=>setLegalModal("privacy")} style={{background:"rgba(44,31,14,0.7)",border:"none",borderRadius:4,padding:"4px 10px",color:"rgba(250,250,247,0.6)",fontSize:8,cursor:"pointer",fontFamily:"'JetBrains Mono',monospace",backdropFilter:"blur(4px)"}}>RGPD · Confidentialité</button>
          </div>
        )}
      </div>
    </LangCtx.Provider>
