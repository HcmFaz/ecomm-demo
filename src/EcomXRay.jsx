...
/* ═══════════════════════════════════════════════════════════════
   NouaSell v4 · Boutique Premium Artisanat Marocain
   Dr. H. Faouzi · ENCG Kénitra 2025/2026
   Style : Chaleureux & Terreux — The Little Market
   i18n : FR / AR / EN  |  10 vues X-Ray académiques
═══════════════════════════════════════════════════════════════ */
...
const TRANS = {
  fr:{
    tagline:"L'artisanat marocain authentique",
    subtitle:"Chaque pièce raconte une histoire.\nChaque achat soutient un artisan.",
    discover:"Découvrir la collection",
    hero_badge:"ARTISANAT CERTIFIÉ MAROC",
    shop:"Boutique", artisan_nav:"Artisans", impact_nav:"Impact",
    cart:"Panier", wishlist:"Favoris", profile:"Profil",
    admin:"Admin", xray:"X-Ray", back:"Retour",
    all:"Tout", mode_cat:"Mode", home_cat:"Maison",
    beauty_cat:"Beauté", food_cat:"Épicerie",
    add_to_cart:"Ajouter au panier", added:"Ajouté !",
    view_product:"Découvrir", by:"Par", from:"de",
    tradition:"Tradition", material:"Matière", technique:"Technique",
    the_story:"L'histoire", the_artisan:"L'artisan",
    traceability:"Traçabilité & origine", the_impact:"Impact",
    certificate:"Certificat d'authenticité",
    families:"familles soutenues", years:"ans de tradition",
    coops:"coopératives partenaires", artisans_n:"artisans certifiés",
    certified:"Certifié authentique", handmade:"Fait main",
    fair_trade:"Commerce équitable", region_l:"Région",
    delivery:"Livraison", free_above:"Gratuite dès 500 MAD",
    standard:"Standard", express:"Express",
    promo:"Code promo", apply:"Appliquer",
    subtotal:"Sous-total", total:"Total",
    checkout:"Passer la commande", shipping:"Informations de livraison",
    payment:"Paiement", confirmation:"Confirmation",
    confirmed:"Commande confirmée", continue:"Continuer mes achats",
    empty_cart:"Votre panier est vide",
    empty_wish:"Votre liste est vide",
    explore:"Explorer les produits",
    my_orders:"Mes commandes", loyalty:"Programme fidélité",
    pts:"points", no_orders:"Aucune commande pour l'instant",
    search:"Rechercher...",
    sort_pop:"Plus populaires", sort_rate:"Mieux notés",
    sort_asc:"Prix croissant", sort_desc:"Prix décroissant",
    compare:"Comparer", reviews:"Avis",
    verified:"Achat vérifié", qty:"Quantité",
    color:"Couleur", size:"Taille",
    stock_label:"En stock", low_stock:"Plus que",
    share:"Partager", send:"→",
    chat_ph:"Posez votre question...",
    chat_title:"Assistant IA NouaSell",
    name_f:"Nom complet", email_f:"Email",
    phone_f:"Téléphone", address_f:"Adresse", city_f:"Ville",
    pay_now:"Payer", tracking:"Suivi de commande",
    pts_earned:"points fidélité gagnés",
    overview:"Tableau de bord", products_t:"Produits",
    analytics_t:"Analytics", rev_t:"Avis clients",
    our_artisans:"Nos artisans",
    our_regions:"Régions du Maroc",
    our_impact:"Notre impact",
    impact_tagline:"Chaque achat a un visage.",
  },
  en:{
    tagline:"Authentic Moroccan Craftsmanship",
    subtitle:"Every piece tells a story.\nEvery purchase supports an artisan.",
    discover:"Discover the collection",
    hero_badge:"CERTIFIED MOROCCAN CRAFTS",
    shop:"Shop", artisan_nav:"Artisans", impact_nav:"Impact",
    cart:"Cart", wishlist:"Wishlist", profile:"Profile",
    admin:"Admin", xray:"X-Ray", back:"Back",
    all:"All", mode_cat:"Fashion", home_cat:"Home",
    beauty_cat:"Beauty", food_cat:"Food",
    add_to_cart:"Add to cart", added:"Added!",
    view_product:"Discover", by:"By", from:"from",
    tradition:"Tradition", material:"Material", technique:"Technique",
    the_story:"The story", the_artisan:"The artisan",
    traceability:"Traceability & origin", the_impact:"Impact",
    certificate:"Certificate of authenticity",
    families:"families supported", years:"years of tradition",
    coops:"partner cooperatives", artisans_n:"certified artisans",
    certified:"Certified authentic", handmade:"Handmade",
    fair_trade:"Fair trade", region_l:"Region",
    delivery:"Delivery", free_above:"Free above 500 MAD",
    standard:"Standard", express:"Express",
    promo:"Promo code", apply:"Apply",
    subtotal:"Subtotal", total:"Total",
    checkout:"Proceed to checkout", shipping:"Shipping information",
    payment:"Payment", confirmation:"Confirmation",
    confirmed:"Order confirmed", continue:"Continue shopping",
    empty_cart:"Your cart is empty",
    empty_wish:"Your wishlist is empty",
    explore:"Explore products",
    my_orders:"My orders", loyalty:"Loyalty program",
    pts:"points", no_orders:"No orders yet",
    search:"Search...",
    sort_pop:"Most popular", sort_rate:"Best rated",
    sort_asc:"Price: low to high", sort_desc:"Price: high to low",
    compare:"Compare", reviews:"Reviews",
    verified:"Verified purchase", qty:"Quantity",
    color:"Color", size:"Size",
    stock_label:"In stock", low_stock:"Only",
    share:"Share", send:"→",
    chat_ph:"Ask your question...",
    chat_title:"NouaSell AI Assistant",
    name_f:"Full name", email_f:"Email",
    phone_f:"Phone", address_f:"Address", city_f:"City",
    pay_now:"Pay now", tracking:"Order tracking",
    pts_earned:"loyalty points earned",
    overview:"Dashboard", products_t:"Products",
    analytics_t:"Analytics", rev_t:"Customer reviews",
    our_artisans:"Our artisans",
    our_regions:"Regions of Morocco",
    our_impact:"Our impact",
    impact_tagline:"Every purchase has a face.",
  },
  ar:{
    tagline:"الحرف المغربية الأصيلة",
    subtitle:"كل قطعة تحكي قصة.\nكل شراء يدعم حرفياً.",
    discover:"اكتشف المجموعة",
    hero_badge:"حرف مغربية معتمدة",
    shop:"المتجر", artisan_nav:"الحرفيون", impact_nav:"التأثير",
    cart:"السلة", wishlist:"المفضلة", profile:"الملف",
    admin:"الإدارة", xray:"X-Ray", back:"رجوع",
    all:"الكل", mode_cat:"أزياء", home_cat:"منزل",
    beauty_cat:"جمال", food_cat:"طعام",
    add_to_cart:"أضف إلى السلة", added:"تمت الإضافة!",
    view_product:"اكتشف", by:"بقلم", from:"من",
    tradition:"التقليد", material:"المادة", technique:"التقنية",
    the_story:"القصة", the_artisan:"الحرفي",
    traceability:"التتبع والأصل", the_impact:"التأثير",
    certificate:"شهادة الأصالة",
    families:"عائلة مدعومة", years:"سنة من التقليد",
    coops:"تعاونية شريكة", artisans_n:"حرفي معتمد",
    certified:"معتمد أصيل", handmade:"صنع يدوي",
    fair_trade:"تجارة عادلة", region_l:"المنطقة",
    delivery:"التوصيل", free_above:"مجاني من 500 درهم",
    standard:"عادي", express:"سريع",
    promo:"رمز الترويج", apply:"تطبيق",
    subtotal:"المجموع الجزئي", total:"المجموع",
    checkout:"إتمام الطلب", shipping:"معلومات الشحن",
    payment:"الدفع", confirmation:"تأكيد",
    confirmed:"تم تأكيد الطلب", continue:"مواصلة التسوق",
    empty_cart:"سلتك فارغة",
    empty_wish:"قائمة المفضلة فارغة",
    explore:"تصفح المنتجات",
    my_orders:"طلباتي", loyalty:"برنامج الولاء",
    pts:"نقطة", no_orders:"لا توجد طلبات بعد",
    search:"بحث...",
    sort_pop:"الأكثر شعبية", sort_rate:"الأعلى تقييماً",
    sort_asc:"السعر: من الأدنى", sort_desc:"السعر: من الأعلى",
    compare:"مقارنة", reviews:"التقييمات",
    verified:"شراء موثق", qty:"الكمية",
    color:"اللون", size:"المقاس",
    stock_label:"متوفر", low_stock:"بقي",
    share:"مشاركة", send:"→",
    chat_ph:"اطرح سؤالك...",
    chat_title:"مساعد NouaSell الذكي",
    name_f:"الاسم الكامل", email_f:"البريد الإلكتروني",
    phone_f:"الهاتف", address_f:"العنوان", city_f:"المدينة",
    pay_now:"ادفع الآن", tracking:"تتبع الطلب",
    pts_earned:"نقطة ولاء مكتسبة",
    overview:"لوحة التحكم", products_t:"المنتجات",
    analytics_t:"التحليلات", rev_t:"تقييمات العملاء",
    our_artisans:"حرفيونا",
    our_regions:"مناطق المغرب",
    our_impact:"تأثيرنا",
    impact_tagline:"كل عملية شراء لها وجه.",
  }
};

/* ── ARTISANS ── */
const ARTISANS = [
  {id:"fatima", nameKey:"Fatima Zahra Benali",
   region:"Fès el-Bali", tradition:{fr:"Broderie fassi sur soie",en:"Fassi silk embroidery",ar:"التطريز الفاسي على الحرير"},
   years:28, coop:{fr:"Coopérative Zina · Fès",en:"Zina Cooperative · Fès",ar:"تعاونية زينة · فاس"},
   products:[1,4],
   story:{
     fr:"Fatima a appris à broder à l'âge de 7 ans, assise aux genoux de sa grand-mère dans la médina de Fès. Ses mains, formées à l'école des maîtresses tisseuses, exécutent aujourd'hui des motifs géométriques qui traversent les siècles.",
     en:"Fatima learned to embroider at age 7, sitting at her grandmother's knees in the medina of Fès. Her hands, trained by master weavers, now create geometric patterns that have crossed centuries.",
     ar:"تعلمت فاطمة التطريز في سن السابعة، جالسةً عند ركبتَي جدتها في مدينة فاس. يداها، المدرَّبتان على يد الأستاذات، تنسجان اليوم أنماطاً هندسية عبرت القرون."
   },
   img:"https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&w=400&h=400&q=80",
   color:"#8B3A62"},
  {id:"hassan", nameKey:"Hassan Alami",
   region:"Marrakech · Mellah", tradition:{fr:"Zellige et mosaïque",en:"Zellige and mosaic",ar:"الزليج والفسيفساء"},
   years:35, coop:{fr:"Maîtres Zellij du Maroc",en:"Masters of Moroccan Zellige",ar:"أساتذة الزليج المغربي"},
   products:[8],
   story:{
     fr:"Hassan est maître zellij depuis 35 ans. Chaque plateau qu'il crée exige des semaines de taille à la main, pièce par pièce, selon les règles géométriques de l'art islamique classique. Il est l'un des rares artisans à maîtriser encore les formules de pigmentation naturelle.",
     en:"Hassan has been a master zellige craftsman for 35 years. Each plateau he creates requires weeks of hand-cutting, piece by piece, following the geometric rules of classical Islamic art.",
     ar:"حسان أستاذ زليج منذ 35 عاماً. كل طبق يصنعه يتطلب أسابيع من القطع اليدوي، قطعةً قطعةً، وفق القواعد الهندسية للفن الإسلامي الكلاسيكي."
   },
   img:"https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&h=400&q=80",
   color:"#C17F3B"},
  {id:"zineb", nameKey:"Zineb Oubella",
   region:"Haut Atlas · Aït Benhaddou", tradition:{fr:"Tissage berbère laine",en:"Berber wool weaving",ar:"النسيج البربري بالصوف"},
   years:20, coop:{fr:"Coopérative Atlas Femmes",en:"Atlas Women Cooperative",ar:"تعاونية نساء الأطلس"},
   products:[6],
   story:{
     fr:"Dans le village de Taznakht, Zineb perpétue un art millénaire — le tissage berbère aux motifs ancestraux qui protègent et narrent l'histoire de sa tribu. Chaque couleur est teintée naturellement avec des plantes de l'Atlas.",
     en:"In the village of Taznakht, Zineb perpetuates an ancient art — Berber weaving with ancestral motifs that protect and narrate the history of her tribe. Each color is naturally dyed with Atlas mountain plants.",
     ar:"في قرية تزناخت، تُديم زينب فناً عريقاً — النسيج البربري بنقوش أجدادية تحكي تاريخ قبيلتها. كل لون مصبوغ طبيعياً بنباتات جبال الأطلس."
   },
   img:"https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=400&h=400&q=80",
   color:"#6B7C5E"},
  {id:"omar", nameKey:"Omar Tazi",
   region:"Fès · Quartier des tanneurs", tradition:{fr:"Maroquinerie & tannerie",en:"Leatherwork & tannery",ar:"الجلد والدباغة"},
   years:22, coop:{fr:"Tanneurs de Fès",en:"Fès Tannery Guild",ar:"دباغو فاس"},
   products:[4],
   story:{
     fr:"Les cuves colorées de la tannerie Chouara sont son atelier depuis 22 ans. Omar travaille le cuir végétal selon des techniques vieilles de mille ans, transformant chaque peau en une pièce unique dont la douceur et la durabilité défient le temps.",
     en:"The colourful vats of the Chouara tannery have been his workshop for 22 years. Omar works vegetable leather using thousand-year-old techniques, transforming each hide into a unique piece whose softness and durability defy time.",
     ar:"أحواض الدباغة الملوّنة في تشويارة ورشته منذ 22 عاماً. عمر يشتغل الجلد النباتي بتقنيات عمرها ألف سنة."
   },
   img:"https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=400&h=400&q=80",
   color:"#8B5A2B"},
];

/* ── PRODUCT IMAGES — gradient palettes + Unsplash ── */
const PIMG = {
  1:{ // Caftan
    palette:["#6B2D4A","#3D1129"],
    imgs:[
      "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1594938298603-e8d9b9c3a5c8?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1571160119752-56cc37acf78d?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1548586196-aa5803b77379?auto=format&fit=crop&w=800&q=75",
    ]},
  2:{ // Argan
    palette:["#8B5E1A","#4A2F08"],
    imgs:[
      "https://images.unsplash.com/photo-1585386959984-a4155224a1ad?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1556228578-0d85b1a4d571?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1536935338788-846bb9981813?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?auto=format&fit=crop&w=800&q=75",
    ]},
  3:{ // Tajine
    palette:["#8B3A1A","#4A1A08"],
    imgs:[
      "https://images.unsplash.com/photo-1551782450-a2132b4ba21d?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1596944924591-9e698bab7e5d?auto=format&fit=crop&w=800&q=75",
    ]},
  4:{ // Babouches
    palette:["#5C3A1A","#3A2010"],
    imgs:[
      "https://images.unsplash.com/photo-1542596594-649edbc13630?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1517481592723-f17e2e85de96?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1559563458-527698bf5295?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?auto=format&fit=crop&w=800&q=75",
    ]},
  5:{ // Thé
    palette:["#2A5A2A","#143014"],
    imgs:[
      "https://images.unsplash.com/photo-1544550285-f813152fb2fd?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1564890369478-c89ca6d9cde9?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1523920290228-4f321a939b4c?auto=format&fit=crop&w=800&q=75",
    ]},
  6:{ // Coussin
    palette:["#5A3A1A","#3A2010"],
    imgs:[
      "https://images.unsplash.com/photo-1547994770-a24e38af5aea?auto=format&fit=crop&w=800&q=75",
      ...
      "https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?auto=format&fit=crop&w=800&q=75",
    ]},
  7:{ // Savon Beldi
    palette:["#2A3A2A","#141E14"],
    imgs:[
      "https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1600857544454-8b21a1c1e8e0?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1570194065650-d99fb4bedf0a?auto=format&fit=crop&w=800&q=75",
    ]},
  8:{ // Zellige
    palette:["#1A3A5A","#0E1E3A"],
    imgs:[
      "https://images.unsplash.com/photo-1551029506-0807df4e2031?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?auto=format&fit=crop&w=800&q=75",
      "https://images.unsplash.com/photo-1596944924591-9e698bab7e5d?auto=format&fit=crop&w=800&q=75",
    ]},
...
/* ── PRODUCTS ── */
const PRODUCTS = [
  {id:1, artisanId:"fatima",
   name:{fr:"Caftan Brodé Royal",en:"Royal Embroidered Caftan",ar:"القفطان الملكي المطرز"},
   cat:"Mode", price:1850, rating:4.8, rCount:124, stock:3, badge:"Bestseller",
   region:{fr:"Fès el-Bali",en:"Fès el-Bali",ar:"فاس البالي"},
   tradition_tag:{fr:"Broderie fassi",en:"Fassi embroidery",ar:"التطريز الفاسي"},
   material:{fr:"Velours & fil d'or",en:"Velvet & gold thread",ar:"مخمل وخيط ذهبي"},
   technique:{fr:"Point de croix manuel",en:"Manual cross-stitch",ar:"غرز يدوية"},
   colors:["Bordeaux","Bleu nuit","Ivoire"], sizes:["S","M","L","XL"],
   story:{
     fr:"Ce caftan est issu d'une tradition de cour vieille de cinq siècles. Chaque motif géométrique, exécuté au fil d'or sur fond de velours, est un langage symbolique : les losanges évoquent la fertilité, les entrelacs la continuité du temps. Il faut plus de 80 heures de broderie pour achever une seule pièce.",
     en:"This caftan comes from a five-century-old court tradition. Each geometric pattern, rendered in gold thread on velvet, is a symbolic language: diamonds evoke fertility, interlaced lines the continuity of time. More than 80 hours of embroidery are needed to complete a single piece.",
     ar:"هذا القفطان من تقليد بلاطي عمره خمسة قرون. كل نقش هندسي منفَّذ بخيط ذهبي على مخمل هو لغة رمزية: المعينات تعني الخصوبة، والأشكال المتشابكة تعني استمرارية الزمن."
   },
   impact:{fr:"Soutient 3 brodeuses de la Coopérative Zina",en:"Supports 3 embroiderers at Zina Cooperative",ar:"يدعم 3 مطرزات في تعاونية زينة"},
   certif:{fr:"Pièce numérotée · Certificat d'origine Fès · Fil d'or certifié",en:"Numbered piece · Fès origin certificate · Certified gold thread",ar:"قطعة مرقّمة · شهادة منشأ فاس · خيط ذهبي معتمد"},
   reviews:[{n:"Salma B.",s:5,t:{fr:"Broderie parfaite, chaque fil compte.",en:"Perfect embroidery, every thread matters.",ar:"تطريز مثالي، كل خيط له أهمية."},v:true,d:"12 jan"},{n:"Karim M.",s:5,t:{fr:"Qualité digne d'un couturier.",en:"Quality worthy of a couturier.",ar:"جودة تليق بمصمم أزياء."},v:true,d:"8 jan"}]},

  {id:2, artisanId:null,
   name:{fr:"Argan Pur Bio 100ml",en:"Pure Organic Argan 100ml",ar:"أركان خالص بيو 100مل"},
   cat:"Beauté", price:280, rating:4.9, rCount:312, stock:45, badge:"Top Ventes",
   region:{fr:"Souss-Massa · Agadir",en:"Souss-Massa · Agadir",ar:"سوس ماسة · أكادير"},
   tradition_tag:{fr:"Or liquide du Maroc",en:"Morocco's liquid gold",ar:"الذهب السائل للمغرب"},
   material:{fr:"Graines d'argania spinosa",en:"Argania spinosa seeds",ar:"بذور شجر الأركان"},
   technique:{fr:"Pression à froid traditionnelle",en:"Traditional cold pressing",ar:"عصر بارد تقليدي"},
   colors:["Standard"], sizes:["50ml","100ml","200ml"],
   story:{
     fr:"L'arganier, arbre endémique du Maroc, pousse dans des conditions arides qui lui confèrent ses propriétés exceptionnelles. Les femmes de la coopérative Targanine récoltent les fruits à la main, concassent les noix manuellement et pressent l'huile selon une méthode transmise de génération en génération depuis des siècles.",
     en:"The argan tree, endemic to Morocco, grows in arid conditions that give it its exceptional properties. The women of the Targanine cooperative harvest the fruit by hand, crack the nuts manually and press the oil using a method passed down through generations for centuries.",
     ar:"شجرة الأركان، المتوطنة في المغرب، تنمو في ظروف جافة تمنحها خصائص استثنائية. نساء تعاونية تارغانين يحصدن الثمار يدوياً ويعصرن الزيت بطريقة توارثتها الأجيال."
   },
   impact:{fr:"Soutient 47 femmes de la coopérative Targanine",en:"Supports 47 women at Targanine cooperative",ar:"يدعم 47 امرأة في تعاونية تارغانين"},
   certif:{fr:"Certifié ECOCERT · Première pression à froid · 100% pur",en:"ECOCERT certified · First cold press · 100% pure",ar:"معتمد ECOCERT · عصرة أولى باردة · نقي 100%"},
   reviews:[{n:"Leila H.",s:5,t:{fr:"Résultats visibles en une semaine.",en:"Visible results in one week.",ar:"نتائج ملموسة في أسبوع."},v:true,d:"15 jan"},{n:"Sara T.",s:5,t:{fr:"4ème commande — fidèle à vie !",en:"4th order — loyal for life!",ar:"الطلب الرابع — مخلصة إلى الأبد!"},v:true,d:"5 jan"}]},

  {id:3, artisanId:null,
   name:{fr:"Tajine Terre Cuite Safi",en:"Safi Earthenware Tajine",ar:"طاجين فخار آسفي"},
   cat:"Maison", price:420, rating:4.7, rCount:89, stock:23, badge:"Artisanat",
   region:{fr:"Safi · Côte Atlantique",en:"Safi · Atlantic Coast",ar:"آسفي · الساحل الأطلسي"},
   tradition_tag:{fr:"Poterie de Safi",en:"Safi pottery",ar:"فخار آسفي"},
   material:{fr:"Argile locale + oxyde de cuivre",en:"Local clay + copper oxide",ar:"طين محلي + أكسيد النحاس"},
   technique:{fr:"Tour manuel + cuisson bois",en:"Manual wheel + wood firing",ar:"دولاب يدوي + حرق بالخشب"},
   colors:["Ocre","Blanc"], sizes:["24cm","28cm","32cm"],
   story:{
     fr:"Safi est la capitale de la céramique marocaine. Les maîtres potiers y façonnent la terre depuis le 12ème siècle, développant un style reconnaissable entre tous — émaux turquoise et verts, formes organiques inspirées de la nature. Ce tajine peut aller directement sur la flamme.",
     en:"Safi is the capital of Moroccan ceramics. Master potters have been shaping clay here since the 12th century, developing a uniquely recognizable style — turquoise and green glazes, organic forms inspired by nature.",
     ar:"آسفي عاصمة الخزف المغربي. يعمل أساتذة الفخار هنا منذ القرن الثاني عشر، مطوِّرين أسلوباً فريداً."
   },
   impact:{fr:"Famille Bensouda · 3ème génération de potiers",en:"Bensouda family · 3rd generation of potters",ar:"عائلة بنصودة · الجيل الثالث من الفخارين"},
   certif:{fr:"Poinçon artisan Safi · Argile certifiée · Sans plomb",en:"Safi artisan hallmark · Certified clay · Lead-free",ar:"ختم حرفي آسفي · طين معتمد · خالٍ من الرصاص"},
   reviews:[{n:"Youssef D.",s:5,t:{fr:"Saveurs incomparables en cuisson.",en:"Incomparable flavours when cooking.",ar:"نكهات لا مثيل لها في الطهي."},v:true,d:"20 jan"},{n:"Fatima Z.",s:4,t:{fr:"Cadeau parfait avec sa boîte.",en:"Perfect gift with its box.",ar:"هدية مثالية مع علبتها."},v:true,d:"14 jan"}]},

  {id:4, artisanId:"omar",
   name:{fr:"Babouches Cuir Naturel",en:"Natural Leather Babouches",ar:"بلاغة جلد طبيعي"},
   cat:"Mode", price:350, rating:4.6, rCount:201, stock:31, badge:"",
   region:{fr:"Fès · Quartier Chouara",en:"Fès · Chouara Quarter",ar:"فاس · حي الشوارة"},
   tradition_tag:{fr:"Maroquinerie fassi",en:"Fassi leatherwork",ar:"الجلد الفاسي"},
   material:{fr:"Cuir végétal tanné",en:"Vegetable-tanned leather",ar:"جلد مدبوغ نباتياً"},
   technique:{fr:"Tannage naturel · Finitions main",en:"Natural tanning · Hand finish",ar:"دباغة طبيعية · إنهاء يدوي"},
   colors:["Naturel","Noir","Camel","Miel"], sizes:["38","39","40","41","42","43","44"],
   story:{
     fr:"Les tanneries de Fès sont l'une des images les plus iconiques du Maroc. Le cuir y est travaillé selon des méthodes inchangées depuis le Moyen-Âge : bains de chaux pour dépiler, cuves de safran et de coquelicot pour la couleur. Omar tanné depuis 22 ans dans la même cuve que son père.",
     en:"The tanneries of Fès are one of Morocco's most iconic images. Leather is worked here using methods unchanged since the Middle Ages: lime baths for hair removal, saffron and poppy vats for colour. Omar has been tanning for 22 years in the same vat as his father.",
     ar:"دباغات فاس من أكثر الصور أيقونية في المغرب. يُعالَج الجلد هنا بأساليب لم تتغير منذ العصور الوسطى."
   },
   impact:{fr:"Emploi direct · Tannerie Chouara · Fès",en:"Direct employment · Chouara Tannery · Fès",ar:"توظيف مباشر · دباغة الشوارة · فاس"},
   certif:{fr:"Cuir végétal non-chromé · Sans produits chimiques · Label Fassi",en:"Chrome-free vegetable leather · Chemical-free · Fassi label",ar:"جلد نباتي بدون كروم · بدون مواد كيميائية · ختم فاسي"},
   reviews:[{n:"Omar L.",s:5,t:{fr:"Confort incroyable, cuir exceptionnel.",en:"Incredible comfort, exceptional leather.",ar:"راحة مذهلة وجلد استثنائي."},v:true,d:"18 jan"},{n:"Rim A.",s:4,t:{fr:"Belle qualité, livraison rapide.",en:"Great quality, fast delivery.",ar:"جودة جيدة وتوصيل سريع."},v:false,d:"9 jan"}]},

  {id:5, artisanId:null,
   name:{fr:"Thé à la Menthe Signature",en:"Signature Mint Tea",ar:"الشاي بالنعناع الأصيل"},
   cat:"Épicerie", price:95, rating:4.9, rCount:445, stock:120, badge:"Favori",
   region:{fr:"Meknes · Plaine du Gharb",en:"Meknes · Gharb Plain",ar:"مكناس · سهل الغرب"},
   tradition_tag:{fr:"Thé de l'hospitalité",en:"Tea of hospitality",ar:"شاي الضيافة"},
   material:{fr:"Gunpowder No 1 + Menthe nana",en:"Gunpowder No 1 + Nana Mint",ar:"جونبودر رقم 1 + نعناع ناناء"},
   technique:{fr:"Séchage naturel à l'ombre",en:"Natural shade drying",ar:"تجفيف طبيعي في الظل"},
   colors:["Signature"], sizes:["50g","100g","200g"],
   story:{
     fr:"Au Maroc, le thé n'est pas une boisson — c'est un rituel. Versé de haut pour créer l'écume, servi trois fois (chacune avec une saveur différente), il symbolise l'hospitalité, la confiance et l'amitié. Notre mélange signature combine le Gunpowder de Chine et la menthe nana cueillie à la main dans la plaine du Gharb.",
     en:"In Morocco, tea is not a drink — it is a ritual. Poured from height to create foam, served three times (each with a different flavour), it symbolises hospitality, trust and friendship. Our signature blend combines Chinese Gunpowder with hand-picked nana mint from the Gharb plain.",
     ar:"في المغرب، الشاي ليس مجرد شراب — إنه طقس. يُسكب من الأعلى لتكوين الرغوة، يُقدَّم ثلاث مرات، يرمز للضيافة والثقة والصداقة."
   },
   impact:{fr:"Soutient 12 familles agricoles du Gharb",en:"Supports 12 farming families from Gharb",ar:"يدعم 12 عائلة فلاحية من الغرب"},
   certif:{fr:"Agriculture raisonnée · Sans pesticides · Récolte manuelle",en:"Sustainable farming · Pesticide-free · Hand-harvested",ar:"زراعة مستدامة · بدون مبيدات · حصاد يدوي"},
   reviews:[{n:"Hassan M.",s:5,t:{fr:"Le rituel du thé retrouvé.",en:"The tea ritual rediscovered.",ar:"طقس الشاي مُستعاد."},v:true,d:"22 jan"}]},

  {id:6, artisanId:"zineb",
   name:{fr:"Coussin Berbère Haut Atlas",en:"High Atlas Berber Cushion",ar:"وسادة أمازيغية أطلس كبير"},
   cat:"Maison", price:680, rating:4.7, rCount:67, stock:14, badge:"Nouveau",
   region:{fr:"Haut Atlas · Taznakht",en:"High Atlas · Taznakht",ar:"الأطلس الكبير · تزناخت"},
   tradition_tag:{fr:"Tissage amazigh",en:"Amazigh weaving",ar:"النسيج الأمازيغي"},
   material:{fr:"Laine de brebis des plateaux",en:"Plateau sheep wool",ar:"صوف نعاج الهضاب"},
   technique:{fr:"Métier à bras traditionnel",en:"Traditional hand loom",ar:"نول يدوي تقليدي"},
   colors:["Naturel","Rouge Oued","Ocre Atlas"], sizes:["40×40cm","50×50cm"],
   story:{
     fr:"Les motifs sur ce coussin ne sont pas de la décoration — ce sont des textes. Chaque symbole berbère (tifinagh) raconte un fragment de vie : le scorpion pour la protection, la pluie pour l'abondance, les chevrons pour la route de la vie. Zineb tisse ces récits depuis l'âge de 12 ans.",
     en:"The patterns on this cushion are not decoration — they are texts. Each Berber symbol (tifinagh) tells a fragment of life: the scorpion for protection, rain for abundance, chevrons for life's journey. Zineb has been weaving these stories since age 12.",
     ar:"النقوش على هذه الوسادة ليست زخرفة — إنها نصوص. كل رمز أمازيغي (تيفيناغ) يحكي جزءاً من الحياة."
   },
   impact:{fr:"Coopérative Atlas Femmes · 34 tisseuses",en:"Atlas Women Cooperative · 34 weavers",ar:"تعاونية نساء الأطلس · 34 ناسجة"},
   certif:{fr:"Laine naturelle · Teinture végétale · Label Amazigh",en:"Natural wool · Vegetable dye · Amazigh label",ar:"صوف طبيعي · صبغ نباتي · ختم أمازيغي"},
   reviews:[{n:"Dounia S.",s:5,t:{fr:"Pièce vivante, chaque motif parle.",en:"A living piece, every motif speaks.",ar:"قطعة حية، كل نقش يتكلم."},v:true,d:"11 jan"}]},

  {id:7, artisanId:null,
   name:{fr:"Savon Beldi Noir Hammam",en:"Black Hammam Beldi Soap",ar:"الصابون البلدي الأسود"},
   cat:"Beauté", price:120, rating:4.8, rCount:289, stock:78, badge:"",
   region:{fr:"Marrakech · Bab Doukkala",en:"Marrakech · Bab Doukkala",ar:"مراكش · باب دكالة"},
   tradition_tag:{fr:"Rituel hammam marocain",en:"Moroccan hammam ritual",ar:"طقس الحمام المغربي"},
   material:{fr:"Huile d'olive + Ghassoul Atlas",en:"Olive oil + Atlas Ghassoul",ar:"زيت زيتون + غاسول الأطلس"},
   technique:{fr:"Macération 6 mois",en:"6-month maceration",ar:"تخمير 6 أشهر"},
   colors:["Standard"], sizes:["200g","400g"],
   story:{
     fr:"Le savon beldi noir n'est pas fabriqué — il est fermenté. Une pâte d'olives pressées à froid, enrichie de ghassoul extrait des montagnes de l'Atlas, macère pendant six mois minimum. Ce processus lent crée des saponines actives qui exfolient en profondeur sans agresser la peau.",
     en:"Black beldi soap is not made — it is fermented. A paste of cold-pressed olives, enriched with ghassoul extracted from the Atlas mountains, macerates for a minimum of six months. This slow process creates active saponins that exfoliate deeply without harming the skin.",
     ar:"الصابون البلدي الأسود لا يُصنع — يُخمَّر. عجينة زيتون مضغوط بارد مع غاسول الأطلس تتخمر ستة أشهر."
   },
   impact:{fr:"Production Dar Cherifa · Marrakech · artisan familial",en:"Dar Cherifa production · Marrakech · family artisan",ar:"إنتاج دار شريفة · مراكش · حرفي عائلي"},
   certif:{fr:"100% naturel · Sans conservateurs · pH équilibré",en:"100% natural · Preservative-free · Balanced pH",ar:"طبيعي 100% · بدون مواد حافظة · pH متوازن"},
   reviews:[{n:"Meryem B.",s:5,t:{fr:"Peau douce après la 1ère utilisation.",en:"Soft skin after first use.",ar:"بشرة ناعمة بعد الاستخدام الأول."},v:true,d:"19 jan"}]},

  {id:8, artisanId:"hassan",
   name:{fr:"Plateau Zellige Doré",en:"Golden Zellige Plateau",ar:"طبق الزليج الذهبي"},
   cat:"Maison", price:950, rating:4.9, rCount:43, stock:4, badge:"Exclusif",
   region:{fr:"Marrakech · Quartier des artisans",en:"Marrakech · Artisans Quarter",ar:"مراكش · حي الحرفيين"},
   tradition_tag:{fr:"Zellige andalou-marocain",en:"Andalusian-Moroccan Zellige",ar:"الزليج الأندلسي المغربي"},
   material:{fr:"Argile émaillée + oxyde d'or",en:"Glazed clay + gold oxide",ar:"طين مزجّج + أكسيد الذهب"},
   technique:{fr:"Taille à main · Pose mosaïque",en:"Hand cutting · Mosaic laying",ar:"قطع يدوي · تركيب فسيفسائي"},
   colors:["Doré","Argenté"], sizes:["30cm","40cm","50cm"],
   story:{
     fr:"Le zellige est né dans les palais andalous du 10ème siècle avant de s'enraciner profondément au Maroc. Chaque pièce est taillée individuellement au marteau et au burin, puis assemblée selon des formules géométriques complexes dérivées de la mathématique islamique. Ce plateau est une pièce numérotée.",
     en:"Zellige was born in the Andalusian palaces of the 10th century before taking deep root in Morocco. Each piece is individually cut with hammer and chisel, then assembled according to complex geometric formulas derived from Islamic mathematics.",
     ar:"وُلد الزليج في القصور الأندلسية في القرن العاشر قبل أن يتجذّر في المغرب. كل قطعة مقطوعة بالمطرقة والإزميل."
   },
   impact:{fr:"Hassan Alami · Maître zellij · Pièce unique numérotée",en:"Hassan Alami · Master zellige · Unique numbered piece",ar:"حسان العلمي · أستاذ زليج · قطعة فريدة مرقّمة"},
   certif:{fr:"Certificat N°{n} · Signature artisan · Marque Maîtres Zellij",en:"Certificate N°{n} · Artisan signature · Masters of Zellige brand",ar:"شهادة رقم {n} · توقيع الحرفي · علامة أساتذة الزليج"},
   reviews:[{n:"Adil K.",s:5,t:{fr:"Pièce d'exception. Le certificat sublime tout.",en:"Exceptional piece. The certificate elevates everything.",ar:"قطعة استثنائية. الشهادة ترفع قيمتها."},v:true,d:"6 jan"}]},
];
    ...
    <div style={{display:"flex",gap:2,background:"rgba(44,31,14,0.08)",borderRadius:7,padding:2,border:`1px solid ${C.border}`}}>
      {[["FR","fr"],["EN","en"],["ع","ar"]].map(([label,code])=>(
        <button key={code} onClick={()=>setLang(code)}
          style={{background:lang===code?C.dark:"transparent",border:"none",borderRadius:5,padding:"4px 8px",color:lang===code?C.cream:C.text2,fontSize:10,cursor:"pointer",fontFamily:"'Outfit',sans-serif",fontWeight:lang===code?700:400,transition:"all .2s",minWidth:26}}>
          {label}
        </button>
      ))}
    </div>
    ...
    try {
      const res=await fetch("https://api.anthropic.com/v1/messages",{
        ...
        body:JSON.stringify({
          ...
          system:`Tu es le guide expert de NouaSell, boutique premium d'artisanat marocain authentique. Réponds en ${lang==="ar"?"arabe":lang==="en"?"anglais":"français"}, ton chaleureux et expert (3 phrases max). Tu connais nos artisans : Fatima (broderie Fès), Hassan (zellige Marrakech), Zineb (tissage Atlas), Omar (cuir Fès). Produits : caftans brodés, huile argan bio, tajines Safi, babouches cuir, thé menthe, coussins berbères, savon beldi, zellige. Livraison 47 pays. Code ENCG2025 = -10%.`,
      ...
      setMsgs(p=>[...p,{from:"bot",text:"⚠️ Connexion indisponible. Essayez : artisan, livraison, paiement, certif."}]);
    }
    setLoading(false);
  };
...
function HeroSection({onDiscover,lang}) {
  ...
  return (
    <div style={{height:"100%",position:"relative",overflow:"hidden",background:"linear-gradient(135deg,#2C1F0E 0%,#4A2E1A 30%,#3A2812 60%,#2C1F0E 100%)"}} dir={dir}>
      {/* Texture overlay */}
      <div style={{position:"absolute",inset:0,backgroundImage:"radial-gradient(ellipse at 20% 50%, rgba(201,169,110,0.15) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(107,124,94,0.1) 0%, transparent 50%)",pointerEvents:"none"}}/>
      {/* Decorative lines */}
      ...
      <div style={{position:"relative",height:"100%",display:"flex",alignItems:"center",padding:"0 8%",maxWidth:1200,margin:"0 auto",width:"100%"}}>
        <div style={{flex:1,opacity:loaded?1:0,transform:loaded?"translateY(0)":"translateY(20px)",transition:"all .9s ease"}}>
          ...
          {/* Title */}
          <h1 style={{fontFamily:"'Cormorant Garamond',serif",fontWeight:600,fontSize:"clamp(32px,5vw,64px)",color:C.cream,lineHeight:1.15,marginBottom:16}}>
            {t("tagline")}
          </h1>
          {/* Subtitle */}
          <p style={{fontFamily:"'Outfit',sans-serif",fontWeight:300,fontSize:"clamp(13px,1.6vw,17px)",color:"rgba(250,250,247,0.65)",lineHeight:1.8,marginBottom:32,maxWidth:500,whiteSpace:"pre-line"}}>
            {t("subtitle")}
          </p>
          {/* CTA */}
          <div style={{display:"flex",gap:14,alignItems:"center",flexWrap:"wrap"}}>
            ...
            <div style={{fontFamily:"'Outfit',sans-serif",fontSize:11,color:"rgba(250,250,247,0.45)",letterSpacing:"0.05em"}}>
              340 {t("artisans_n")} · 47 {t("countries") || "pays"}
            </div>
          </div>
          {/* Stats strip */}
          <div style={{display:"flex",gap:28,marginTop:48,paddingTop:28,borderTop:"1px solid rgba(201,169,110,0.2)"}}>
            {[["340",t("artisans_n")],["12k+",t("orders")||"commandes"],["47",t("countries")||"pays"],["8",t("years")||"ans"]].map(([v,l])=>(
              <div key={l}>
        ...
        <div style={{width:"38%",flexShrink:0,display:"flex",justifyContent:"center",alignItems:"center",opacity:loaded?1:0,transition:"opacity 1.2s ease .3s"}}>
          <div style={{position:"relative",width:280,height:280}}>
            ...
            {[{emoji:"👘",x:0,y:40},{emoji:"🫙",x:230,y:20},{emoji:"✨",x:240,y:200},{emoji:"🍵",x:10,y:210}].map((f,i)=>(
              <div key={i} style={{position:"absolute",left:f.x,top:f.y,width:44,height:44,borderRadius:"50%",background:"rgba(250,250,247,0.06)",border:"1px solid rgba(201,169,110,0.2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:20,animation:`pulseGlow ${2+i*.4}s ease infinite`}}>{f.emoji}</div>
            ))}
          </div>
        </div>
      </div>
...
function ProductImage({productId,idx=0,style={},fill=false}) {
  const [failed,setFailed]=useState(false);
  const data=PIMG[productId];
  if(!data)return<div style={{...style,background:`linear-gradient(135deg,${C.bg2},${C.bg3})`}}/>;
  const [c1,c2]=data.palette;
  if(failed||!data.imgs[idx])return(
    <div style={{...style,background:`linear-gradient(135deg,${c1},${c2})`,display:"flex",alignItems:"center",justifyContent:"center"}}>
      <div style={{fontSize:fill?70:50,opacity:.8,filter:"drop-shadow(0 4px 12px rgba(0,0,0,0.3))"}}>{PRODUCTS.find(p=>p.id===productId)?.id===1?"👘":PRODUCTS.find(p=>p.id===productId)?.id===2?"🫙":"✨"}</div>
    </div>
  );
  return(
    <img src={data.imgs[idx]} alt="" onError={()=>setFailed(true)}
      style={{...style,objectFit:"cover",objectPosition:"center"}}/>
  );
}

/* ══ STORE VIEW ══════════════════════════════════════════════ */
function StoreView({products,onAdd,wishlist,onWish,fx,lang,onOpenArtisans}) {
  const t=useT();
  ...
  const [view,setView]=useState("shop"); // shop | artisans | impact | map
  const dir=lang==="ar"?"rtl":"ltr";
                ...
                {filtered.map((p,i)=>{
                  ...
                  return (
                    <div key={p.id} style={{background:C.cream,border:`1px solid ${inC?C.dark:C.border}`,borderRadius:12,overflow:"hidden",transition:"all .3s",boxShadow:inC?"0 0 0 2px "+C.dark:"0 1px 6px rgba(44,31,14,0.07)",animation:`fadeUp .35s ease ${i*.04}s both`}}
                      ...
                      {/* Image */}
                      <div style={{height:256,position:"relative",overflow:"hidden",cursor:"pointer"}} onClick={()=>setSelected(p)}>
                        <ProductImage productId={p.id} idx={0} style={{width:"100%",height:"100%"}} fill/>
                        {/* Overlays */}
                        ...
                        {low&&<div style={{position:"absolute",top:10,right:10,background:"rgba(196,87,42,0.9)",color:"#fff",fontSize:8,fontWeight:700,padding:"3px 8px",fontFamily:"'Outfit',sans-serif"}}>⚡ {t("low_stock")} {p.stock}</div>}
                        {artisan&&<div style={{position:"absolute",bottom:0,left:0,right:0,padding:"20px 12px 10px",background:"linear-gradient(transparent,rgba(44,31,14,0.7))",fontFamily:"'Outfit',sans-serif",fontSize:9,color:"rgba(250,250,247,0.8)"}}>{t("by")} {artisan.nameKey}</div>}
                        <button onClick={e=>{e.stopPropagation();onWish(p);}} style={{position:"absolute",bottom:8,right:8,background:"rgba(250,250,247,0.88)",border:"none",borderRadius:"50%",width:30,height:30,cursor:"pointer",fontSize:14,display:"flex",alignItems:"center",justifyContent:"center",animation:inW?"heartPop .3s ease":"none"}}>{inW?"❤️":"🤍"}</button>
                      </div>
                      {/* Info */}
    ...
    <div style={{flex:1,overflowY:"auto",background:C.bg}} dir={dir}>
      <div style={{background:C.dark,padding:"20px 40px",display:"flex",alignItems:"center",gap:14}}>
        ...
        <div>
          ...
          <div style={{fontFamily:"'Outfit',sans-serif",fontSize:11,color:C.gold}}>{wishlist.length} {t("items")||"article(s)"}</div>
        </div>
      </div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(230px,1fr))",gap:18}}>
            {wishlist.map((p,i)=>(
              <div key={p.id} style={{background:C.cream,border:`1px solid ${C.border}`,borderRadius:12,overflow:"hidden",animation:`fadeUp .3s ease ${i*.05}s both`,transition:"all .25s"}}
                ...
                <div style={{height:220,position:"relative",overflow:"hidden",cursor:"pointer"}} onClick={()=>setSelected(p)}>
                  <ProductImage productId={p.id} idx={0} style={{width:"100%",height:"100%"}} fill/>
                  <button onClick={e=>{e.stopPropagation();onWish(p);}} style={{position:"absolute",top:10,right:10,background:"rgba(250,250,247,0.9)",border:"none",borderRadius:"50%",width:30,height:30,cursor:"pointer",fontSize:14,display:"flex",alignItems:"center",justifyContent:"center"}}>❤️</button>
                </div>
                <div style={{padding:"12px 14px"}}>
...
function CompareModal({products,onClose,fx,lang}) {
  const t=useT();
  const rows=[
    [t("price")||"Prix",p=>fx(p.price)],
    [t("reviews")||"Avis",p=>`${"★".repeat(Math.floor(p.rating))} ${p.rating} (${p.rCount})`],
    [t("region_l")||"Région",p=>p.region[lang]||p.region.fr],
    [t("tradition")||"Tradition",p=>p.tradition_tag[lang]||p.tradition_tag.fr],
    [t("material")||"Matière",p=>p.material[lang]||p.material.fr],
    [t("stock_label")||"Stock",p=>`${p.stock} u.`],
  ];
  return (
          ...
          <table style={{borderCollapse:"collapse",width:"100%",fontFamily:"'Outfit',sans-serif"}}>
            <thead><tr><th style={{padding:"8px 14px",textAlign:"left",fontSize:11,color:C.sub,fontWeight:600,borderBottom:`2px solid ${C.border}`}}></th>
              {products.map(p=><th key={p.id} style={{padding:"8px 18px",textAlign:"center",borderBottom:`2px solid ${C.border}`,minWidth:140}}>
                <div style={{height:80,borderRadius:8,overflow:"hidden",marginBottom:8}}><ProductImage productId={p.id} idx={0} style={{width:"100%",height:"100%"}} fill/></div>
  ...
  return (
    <div onClick={onClose} style={{position:"fixed",inset:0,background:"rgba(44,31,14,0.55)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"}}>
      <div onClick={e=>e.stopPropagation()} className="fu" dir={dir}
        style={{background:C.cream,borderRadius:0,width:740,maxWidth:"96vw",maxHeight:"94vh",overflow:"hidden",boxShadow:"0 30px 90px rgba(44,31,14,0.3)",display:"flex",flexDirection:"column"}}>

        <div style={{display:"flex",flex:1,overflow:"hidden"}}>
          {/* Left — gallery */}
          <div style={{width:300,flexShrink:0,display:"flex",flexDirection:"column",background:C.bg3}}>
            {/* Main image */}
            <div style={{flex:1,position:"relative",overflow:"hidden",cursor:"pointer"}} onClick={()=>setShowCertif(true)}>
              <ProductImage productId={p.id} idx={imgIdx} style={{width:"100%",height:"100%"}} fill/>
              <button onClick={e=>{e.stopPropagation();onWish(p);}} style={{position:"absolute",top:12,right:12,background:"rgba(250,250,247,0.9)",border:"none",borderRadius:"50%",width:34,height:34,cursor:"pointer",fontSize:16,display:"flex",alignItems:"center",justifyContent:"center",animation:inW?"heartPop .3s ease":"none"}}>{inW?"❤️":"🤍"}</button>
              {p.stock<=5&&<div style={{position:"absolute",top:12,left:12,background:"rgba(196,87,42,0.92)",color:"#fff",fontSize:8,fontWeight:700,padding:"4px 9px",fontFamily:"'Outfit',sans-serif"}}>⚡ {t("low_stock")} {p.stock}</div>}
              {/* Certif hint */}
              <div style={{position:"absolute",bottom:10,left:0,right:0,display:"flex",justifyContent:"center"}}>
                <div style={{background:"rgba(44,31,14,0.65)",borderRadius:4,padding:"3px 10px",fontFamily:"'Outfit',sans-serif",fontSize:8,color:"rgba(250,250,247,0.7)",letterSpacing:"0.08em",cursor:"pointer"}}>🏅 {t("certificate")}</div>
              </div>
            </div>
            {/* Thumbnails */}
            <div style={{display:"flex",gap:4,padding:"8px",background:C.bg2}}>
              {(PIMG[p.id]?.imgs||[]).map((_,i)=>(
                <div key={i} onClick={()=>setImgIdx(i)} style={{flex:1,height:52,borderRadius:4,overflow:"hidden",cursor:"pointer",border:`2px solid ${imgIdx===i?C.dark:"transparent"}`,transition:"border-color .2s"}}>
                  <ProductImage productId={p.id} idx={i} style={{width:"100%",height:"100%"}} fill/>
                </div>
              ))}
            </div>
          </div>
                ...
                <div>
                  <div style={{display:"flex",gap:14,alignItems:"flex-start",marginBottom:16}}>
                    <div style={{width:64,height:64,borderRadius:0,overflow:"hidden",flexShrink:0}}>
                      <img src={artisan.img} alt={artisan.nameKey} onError={e=>{e.target.style.display="none";}} style={{width:"100%",height:"100%",objectFit:"cover"}}/>
                    </div>
                    <div>
            ...
            <div style={{padding:"12px 20px",borderTop:`1px solid ${C.border}`,flexShrink:0,background:C.cream}}>
              ...
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10}}>
                ...
                <div style={{display:"flex",gap:8,alignItems:"center"}}>
                  <div style={{display:"flex",alignItems:"center",gap:8,border:`1px solid ${C.border}`,borderRadius:0,padding:"6px 10px"}}>
                    <button onClick={()=>setQty(Math.max(1,qty-1))} style={{background:"transparent",border:"none",cursor:"pointer",fontSize:16,color:C.text2,width:20,display:"flex",alignItems:"center",justifyContent:"center"}}>−</button>
                    ...
                    <button onClick={()=>setQty(Math.min(p.stock,qty+1))} style={{background:"transparent",border:"none",cursor:"pointer",fontSize:16,color:C.text2,width:20,display:"flex",alignItems:"center",justifyContent:"center"}}>+</button>
                  </div>
  ...
  return (
    <div onClick={onClose} style={{position:"fixed",inset:0,background:"rgba(44,31,14,0.7)",zIndex:300,display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(8px)"}}>
      <div onClick={e=>e.stopPropagation()} className="fu"
        style={{background:"linear-gradient(135deg,#FAFAF7 0%,#F5EDE0 40%,#EDE0CC 100%)",borderRadius:0,width:480,maxWidth:"94vw",boxShadow:"0 30px 80px rgba(44,31,14,0.35)",position:"relative",overflow:"hidden"}}>
        {/* Decorative border */}
        <div style={{position:"absolute",inset:10,border:`1px solid ${C.gold}`,borderRadius:0,pointerEvents:"none",opacity:.4}}/>
        <div style={{position:"absolute",inset:14,border:`1px solid ${C.gold}`,borderRadius:0,pointerEvents:"none",opacity:.15}}/>
        {/* Corner ornaments */}
        {[[0,0,"╔"],[0,"auto","╗"],["auto",0,"╚"],["auto","auto","╝"]].map(([t2,r2,ch],i)=>(
          <div key={i} style={{position:"absolute",top:t2,right:r2,bottom:t2==="auto"?0:undefined,left:r2==="auto"?0:undefined,fontFamily:"'Cormorant Garamond',serif",fontSize:20,color:C.gold,opacity:.5,padding:6}}>{ch}</div>
        ))}
        <div style={{padding:"36px 40px",textAlign:"center"}}>
          ...
          {artisan&&(
            <div style={{display:"flex",gap:12,alignItems:"center",padding:"12px 14px",background:"rgba(44,31,14,0.04)",border:`1px solid ${C.border}`,marginBottom:20}}>
              ...
              <div style={{textAlign:"left"}}>
                ...
                <div style={{fontFamily:"'Outfit',sans-serif",fontSize:9,color:C.amber}}>{artisan.region} · {artisan.years} ans d'expérience</div>
              </div>
          ...
          <div style={{display:"flex",gap:6,justifyContent:"center",flexWrap:"wrap",marginBottom:20}}>
            {[t("certified"),t("handmade"),t("fair_trade")].map(badge=>(
              <div key={badge} style={{background:"transparent",border:`1px solid ${C.gold}`,borderRadius:0,padding:"4px 12px",fontFamily:"'JetBrains Mono',monospace",fontSize:7,color:C.amber,letterSpacing:"0.12em"}}>{badge.toUpperCase()}</div>
            ))}
          </div>
          {/* Footer */}
          ...
          <button onClick={onClose} style={{marginTop:20,background:"transparent",border:`1px solid ${C.border}`,borderRadius:0,padding:"10px 28px",color:C.text2,fontSize:11,cursor:"pointer",fontFamily:"'Outfit',sans-serif",letterSpacing:"0.06em",transition:"all .2s"}} onMouseEnter={e=>e.currentTarget.style.background=C.dark+", color:"+C.cream} onMouseLeave={e=>e.currentTarget.style.background="transparent"}>✕ Fermer</button>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{flex:1,overflowY:"auto",background:C.bg,padding:"40px"}} dir={dir}>
      <div style={{maxWidth:1000,margin:"0 auto"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))",gap:20,marginBottom:40}}>
          {ARTISANS.map((a,i)=>(
            <div key={a.id} onClick={()=>setSelected(selected?.id===a.id?null:a)}
              style={{background:C.cream,border:`1px solid ${selected?.id===a.id?C.dark:C.border}`,borderRadius:0,overflow:"hidden",cursor:"pointer",transition:"all .3s",animation:`fadeUp .35s ease ${i*.08}s both`,boxShadow:selected?.id===a.id?"0 12px 40px rgba(44,31,14,0.15)":"0 2px 8px rgba(44,31,14,0.06)"}}
              ...
              <div style={{height:200,overflow:"hidden",position:"relative"}}>
                <img src={a.img} alt={a.nameKey} onError={e=>{e.target.style.display="none";}} style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"center top",transition:"transform .5s"}}
              ...
              <div style={{padding:"12px 14px",background:selected?.id===a.id?C.bg2:C.cream}}>
                ...
                <div style={{fontFamily:"'Outfit',sans-serif",fontSize:10,color:C.sub,marginBottom:6}}>{a.coop[lang]||a.coop.fr}</div>
                <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                  <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:9,color:C.text2}}>{a.years} {t("years")}</div>
                  <div style={{fontFamily:"'Outfit',sans-serif",fontSize:9,color:C.sage}}>{a.products.length} {t("products")||"produit(s)"}</div>
                </div>
              </div>
            </div>
          ))}
        ...
        {selected&&(
          <div className="fu" style={{background:C.cream,border:`1px solid ${C.border}`,borderRadius:0,padding:"28px 32px",marginBottom:24,boxShadow:"0 8px 32px rgba(44,31,14,0.1)"}}>
    ...
    <div style={{padding:"40px",background:C.bg,flex:1,overflowY:"auto"}}>
      <div style={{maxWidth:1000,margin:"0 auto"}}>
        <div style={{marginBottom:28}}>
          ...
          <p style={{fontFamily:"'Outfit',sans-serif",fontSize:13,color:C.text2,lineHeight:1.8,maxWidth:500}}>Chaque région du Maroc possède ses traditions, ses matières, ses maîtres. Explorez les origines de nos créations.</p>
        </div>
        <div style={{display:"flex",gap:24,flexWrap:"wrap"}}>
          ...
          <div style={{background:C.cream,border:`1px solid ${C.border}`,padding:16,flex:"1 1 340px",minHeight:320,position:"relative"}}>
            <svg viewBox="0 0 100 100" style={{width:"100%",height:"100%",maxHeight:360}}>
              ...
              <text x="90" y="15" fontSize="3" fill={C.sub} fontFamily="Outfit,sans-serif" opacity=".3">↑</text>
            </svg>
          </div>
          {/* Region list */}
          <div style={{flex:"1 1 260px",display:"flex",flexDirection:"column",gap:10}}>
            {REGIONS.map(r=>(
              <div key={r.id} onClick={()=>setHovered(hovered?.id===r.id?null:r)}
                style={{background:hovered?.id===r.id?C.bg2:C.cream,border:`1px solid ${hovered?.id===r.id?r.color:C.border}`,padding:"12px 14px",cursor:"pointer",transition:"all .2s",boxShadow:hovered?.id===r.id?`0 4px 16px rgba(44,31,14,0.1)`:"none"}}
...
function ImpactSection({lang}) {
  const t=useT();
  const STATS=[
    {n:"340",l:{fr:"artisans certifiés",en:"certified artisans",ar:"حرفياً معتمداً"},icon:"👐"},
    {n:"12",l:{fr:"coopératives partenaires",en:"partner cooperatives",ar:"تعاونية شريكة"},icon:"🤝"},
    {n:"1 200+",l:{fr:"familles soutenues",en:"families supported",ar:"عائلة مدعومة"},icon:"🏡"},
    {n:"8",l:{fr:"ans de tradition préservée",en:"years of tradition preserved",ar:"سنوات من التقليد"},icon:"🕰️"},
    {n:"100%",l:{fr:"matières naturelles & locales",en:"natural & local materials",ar:"مواد طبيعية ومحلية"},icon:"🌿"},
    {n:"47",l:{fr:"pays livrés",en:"countries delivered",ar:"دولة يُوصَّل إليها"},icon:"🌍"},
  ];
  const COMMITMENTS=[
    {icon:"💰",title:{fr:"Prix équitable",en:"Fair pricing",ar:"سعر عادل"},desc:{fr:"Nos artisans reçoivent 70–80% du prix de vente, soit 3–4× le revenu moyen du secteur informel.",en:"Our artisans receive 70-80% of the sale price, 3-4× the average income in the informal sector.",ar:"يتلقى حرفيونا 70-80% من سعر البيع، أي 3-4 أضعاف متوسط دخل القطاع غير الرسمي."}},
    {icon:"📜",title:{fr:"Traçabilité totale",en:"Full traceability",ar:"تتبع كامل"},desc:{fr:"Chaque produit est accompagné d'un certificat indiquant l'artisan, la région, les matières et la technique utilisée.",en:"Each product comes with a certificate listing the artisan, region, materials and technique used.",ar:"كل منتج مصحوب بشهادة تذكر الحرفي والمنطقة والمواد والتقنية."}},
    {icon:"🌱",title:{fr:"Matières durables",en:"Sustainable materials",ar:"مواد مستدامة"},desc:{fr:"Aucun produit chimique non-naturel. Teintures végétales, cuir végétal, pression à froid — cycle court.",en:"No non-natural chemicals. Vegetable dyes, vegetable leather, cold pressing — short cycle.",ar:"لا مواد كيميائية غير طبيعية. أصباغ نباتية وجلد نباتي وعصر بارد — دورة قصيرة."}},
    {icon:"📚",title:{fr:"Transmission du savoir",en:"Knowledge transmission",ar:"نقل المعرفة"},desc:{fr:"10% de nos revenus financent des ateliers de formation pour la prochaine génération d'artisans marocains.",en:"10% of our revenue funds training workshops for the next generation of Moroccan artisans.",ar:"10% من عائداتنا يمول ورش تدريب للجيل القادم من الحرفيين المغاربة."}},
  ];
  return (
    <div style={{flex:1,overflowY:"auto",background:C.bg,padding:"0"}}>
      {/* Hero */}
      <div style={{background:`linear-gradient(135deg,#2C1F0E,#4A2E1A)`,padding:"48px 60px",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{position:"relative",maxWidth:700}}>
          ...
          <p style={{fontFamily:"'Outfit',sans-serif",fontWeight:300,fontSize:14,color:"rgba(250,250,247,0.65)",lineHeight:1.8,maxWidth:500}}>NouaSell n'est pas une marketplace. C'est un pont entre des mains qui créent et des maisons qui accueillent. Chaque dirham compte.</p>
        </div>
      </div>
      {/* Stats */}
      <div style={{padding:"40px 60px",maxWidth:1100,margin:"0 auto"}}>
        ...
        <div style={{marginBottom:40}}>
          <h3 style={{fontFamily:"'Cormorant Garamond',serif",fontWeight:600,fontSize:26,color:C.text,marginBottom:20}}>Nos engagements</h3>
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))",gap:16}}>
            {COMMITMENTS.map((c,i)=>(
              <div key={i} style={{background:C.cream,border:`1px solid ${C.border}`,padding:"20px 20px"}}>
                <div style={{fontSize:24,marginBottom:12}}>{c.icon}</div>
                <div style={{fontFamily:"'Cormorant Garamond',serif",fontWeight:600,fontSize:18,color:C.text,marginBottom:8}}>{c.title[lang]||c.title.fr}</div>
                <p style={{fontFamily:"'Outfit',sans-serif",fontSize:11,color:C.text2,lineHeight:1.7}}>{c.desc[lang]||c.desc.fr}</p>
              </div>
            ))}
          </div>
        </div>
        {/* Artisan profiles inline */}
        <div>
          ...
          <div style={{display:"flex",gap:16,overflowX:"auto",paddingBottom:8}}>
            {PRODUCTS.flatMap(p=>p.reviews.map(r=>({...r,product:p.name[lang]||p.name.fr}))).filter(r=>r.v).slice(0,6).map((r,i)=>(
              <div key={i} style={{background:C.cream,border:`1px solid ${C.border}`,padding:"16px 18px",minWidth:220,flexShrink:0}}>
                ...
                <p style={{fontFamily:"'Cormorant Garamond',serif",fontSize:14,color:C.text2,lineHeight:1.7,marginBottom:8}}>"{r.t[lang]||r.t.fr}"</p>
                <div style={{fontFamily:"'Outfit',sans-serif",fontSize:9,color:C.sub}}>{r.product}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div style={{display:"flex",gap:18,alignItems:"flex-start",paddingBottom:20,flexWrap:"wrap"}}>
            ...
            <div style={{flex:1}}>
              ...
              <div style={{display:"flex",gap:20,flexWrap:"wrap"}}>
                {[{l:t("my_orders"),v:orders.length},{l:t("total")||"Dépensé",v:`${totalSpent.toLocaleString()} MAD`},{l:t("pts"),v:`⭐ ${loyaltyPts}`},{l:t("loyalty"),v:`🏅 ${LEVEL}`}].map(k=>(
      ...
      <div style={{padding:"28px 40px",maxWidth:960,margin:"0 auto"}}>
          ...
          <div>
            {orders.length===0?(
              <div style={{textAlign:"center",padding:"50px",background:C.cream,border:`1px solid ${C.border}`}}>
                ...
                <div style={{fontFamily:"'Cormorant Garamond',serif",fontWeight:600,fontSize:20,color:C.text2,marginBottom:8}}>{t("no_orders")}</div>
              </div>
            ):orders.map((o,i)=>(
              <div key={o.id} style={{background:C.cream,border:`1px solid ${C.border}`,padding:"16px 20px",marginBottom:10,animation:`fadeUp .3s ease ${i*.05}s both`}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
                  <div>
                    <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:11,color:C.amber,marginBottom:2}}>{o.id}</div>
                    <div style={{fontFamily:"'Outfit',sans-serif",fontSize:11,color:C.sub}}>{o.date}</div>
                  </div>
                ...
                <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
                  {o.items.map((item,j)=>(
                    <div key={j} style={{display:"flex",alignItems:"center",gap:6,background:C.bg2,border:`1px solid ${C.border}`,padding:"4px 10px"}}>
                      <span style={{fontFamily:"'Outfit',sans-serif",fontSize:10,color:C.text}}>{item.name[lang]||item.name.fr||item.name} ×{item.qty}</span>
                      <span style={{fontFamily:"'Cormorant Garamond',serif",fontWeight:600,fontSize:11,color:C.text}}>{fx(item.price*item.qty)}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {tab==="loyalty"&&(
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
            {[
              {title:"🎯 Offres personnalisées",desc:"Sélection basée sur vos achats et vos favoris.",slide:"Personnalisation · Slide 19",color:C.amber},
              {title:"🔔 Alertes de prix",desc:"Notification quand un article de vos favoris baisse.",slide:"Densité d'info · Slide 20",color:C.sage},
              {title:"📦 Livraison prioritaire",desc:"File prioritaire dès le niveau Argent.",slide:"Portée mondiale · Slide 15",color:C.gold},
              {title:"🏅 Points doublés",desc:"×2 points sur les achats depuis la wishlist.",slide:"Tech. Sociale · Slide 21",color:C.amber},
            ].map(card=>(
            ...
            :<>
              {cart.map(item=>(
                <div key={item.key} style={{display:"flex",gap:10,alignItems:"center",padding:"10px 0",borderBottom:`1px solid ${C.border}`}}>
                  <div style={{width:50,height:50,overflow:"hidden",flexShrink:0}}><ProductImage productId={item.id} idx={0} style={{width:"100%",height:"100%"}} fill/></div>
                  <div style={{flex:1}}>
          ...
          {step===2&&(
            <div style={{display:"flex",flexDirection:"column",gap:14}}>
              ...
              <div style={{background:C.bg2,border:`1px solid ${C.border}`,padding:"12px 14px"}}>
                <div style={{fontFamily:"'Outfit',sans-serif",fontWeight:700,fontSize:11,color:C.text2,marginBottom:8}}>{t("subtotal")}</div>
                {cart.map(i=>(
          ...
          {step===3&&confirmed&&(
            <div style={{textAlign:"center"}}>
              ...
              <div style={{background:"linear-gradient(135deg,#FFF8F0,#FFFBF5)",border:`1px solid ${C.border}`,padding:"14px 16px",marginBottom:16,display:"flex",alignItems:"center",gap:10}}>
                ...
                <div style={{textAlign:"left"}}>
                  <div style={{fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:14,color:C.amber}}>+{Math.round(confirmed.total/10)} {t("pts_earned")}</div>
                </div>
              </div>
              {/* Tracking */}
      ...
      <div style={{flex:1,overflowY:"auto",padding:"22px 26px"}}>
        {tab==="overview"&&(
          <div>
            ...
            <div style={{fontFamily:"'Outfit',sans-serif",fontSize:11,color:C.xsub,marginBottom:18}}>KPIs temps réel · Slides 108</div>
        ...
        {tab==="orders"&&(
          <div>
            <h2 style={{fontFamily:"'Syne',sans-serif",fontWeight:800,fontSize:17,color:C.xtext,marginBottom:18}}>Commandes O2C · Slides 86</h2>
            {orders.length===0
        ...
        {tab==="products"&&(
          <div>
            <h2 style={{fontFamily:"'Syne',sans-serif",fontWeight:800,fontSize:17,color:C.xtext,marginBottom:18}}>Catalogue · Slides 69</h2>
            <div style={{background:C.xs1,border:`1px solid ${C.xb}`,borderRadius:12,overflow:"hidden"}}>
              <table style={{width:"100%",borderCollapse:"collapse",fontFamily:"'Outfit',sans-serif",fontSize:12}}>
                <thead><tr style={{background:C.xbg}}>{["Produit","Région","Prix MAD","Stock","Note"].map(h=><th key={h} style={{padding:"9px 12px",textAlign:"left",fontSize:9,color:C.xdim,letterSpacing:"0.1em",fontWeight:700,borderBottom:`1px solid ${C.xb}`}}>{h.toUpperCase()}</th>)}</tr></thead>
        ...
        {tab==="analytics"&&(
          <div>
            <h2 style={{fontFamily:"'Syne',sans-serif",fontWeight:800,fontSize:17,color:C.xtext,marginBottom:18}}>Analytics · Slides 98–110</h2>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:12}}>
              {[{l:"Conversion",v:"3.4%",c:C.green},{l:"Panier moyen",v:"847 MAD",c:C.xambr},{l:"Taux rétention",v:"68%",c:C.cyan}].map(m=>(
...
function XRayView() {
  ...
  const CARAC=[
    {id:"ubiquite",icon:"🌐",label:"Ubiquité",color:"#38BDF8",slide:"Slide 14",def:"Accessible partout, à tout moment, sur tout appareil.",nouasell:"PWA installable. 24h/24. 0 installation.",code:"// Service Worker\nself.addEventListener('fetch', e => {\n  e.respondWith(\n    caches.match(e.request)\n      .then(r => r || fetch(e.request))\n  )\n})",where:"Hero → Badge devices"},
    ...
    {id:"richesse",icon:"🎬",label:"Richesse",color:"#F472B6",slide:"Slide 17",def:"Messages riches : vidéo HD, 360°, PDF, certificat. Impossible en traditionnel.",nouasell:"4 images HD par produit. Certificat d'authenticité. Vidéo artisan.",code:"<Image src={p.img} quality={90}\n  formats={['avif','webp']}\n  placeholder='blur'/>",where:"Fiche produit → 4 photos + certif"},
    {id:"interactivite",icon:"💬",label:"Interactivité",color:"#FB923C",slide:"Slide 18",def:"Communication bidirectionnelle temps réel.",nouasell:"Chat IA Claude API intégré. FAQ dynamique.",code:"supabase.channel('chat')\n  .on('postgres_changes',{\n    event:'INSERT', table:'messages'\n  }, handleMsg)\n  .subscribe()",where:"Bouton 💬 → Claude AI Chat"},
    {id:"personnalisation",icon:"🎯",label:"Personnalisation",color:"#FBBF24",slide:"Slide 19",def:"Personnalisation de masse sans coût marginal.",nouasell:"3 langues FR/EN/AR. Profil artisan dynamique. Recommandations.",code:"SELECT p.* FROM products p\nJOIN user_views uv ON p.category=uv.category\nWHERE uv.user_id=$1\nORDER BY p.rating DESC LIMIT 4",where:"i18n complet · Profil client"},
    {id:"densite",icon:"📊",label:"Densité d'information",color:"#60A5FA",slide:"Slide 20",def:"Asymétrie réduite. Traçabilité totale. Comparaison transparente.",nouasell:"Région, artisan, matière, certif, impact — sur chaque fiche.",code:"SELECT DATE_TRUNC('day',created_at) day,\n  COUNT(*) orders,\n  AVG(total) avg_basket\nFROM orders GROUP BY 1",where:"Fiche → Traçabilité / Admin Analytics"},
    {id:"social",icon:"👥",label:"Technologie Sociale",color:"#4ADE80",slide:"Slide 21",def:"Avis, partage, co-création intégrés à l'achat.",nouasell:"Avis vérifiés. Partage WhatsApp/Instagram. Page Artisans. Impact.",code:"CREATE TABLE reviews (\n  verified_purchase BOOLEAN DEFAULT FALSE,\n  rating INT CHECK (rating BETWEEN 1 AND 5),\n  helpful_votes INT DEFAULT 0\n);",where:"Section Artisans / Communauté / ❤️"},
  ];
  ...
  const REVENUE_MODELS=[
    ...
    {icon:"🔄",label:"Abonnement Artisan",color:C.cyan,slide:"Slide 37",desc:"299 MAD/mois — outils analytics, boost, badge certifié.",ex:"340 artisans × 299 MAD = 101 660 MAD MRR"},
    ...
    {icon:"📊",label:"Data B2B",color:C.pink,slide:"Slide 42",desc:"Rapports sectoriels artisanat marocain vendus aux marques.",ex:"Haute marge · Valorise les actifs existants"},
  ];

  const COMPETITORS=[
    {name:"NouaSell",emoji:"🏛️",modele:"Commission+Abo",force:"Authenticité certifiée",part:"2%",note:4.8,color:C.gold},
  ...
  const LAYERS=[
    {id:"client",label:"COUCHE CLIENT",color:C.cyan,nodes:[{id:"browser",label:"Navigateur",sub:"React/Next.js",icon:"🌐",code:"export default async function Page({params}) {\n  const p = await getProduct(params.slug)\n  return <ProductView product={p}/>\n}",course:"Slides 56–59"},{id:"pwa",label:"PWA / Mobile",sub:"Service Worker",icon:"📱",code:'{ "display":"standalone",\n  "start_url":"/",\n  "theme_color":"#2C1F0E" }',course:"Slides 62–64"},{id:"cdn",label:"CDN Edge",sub:"Vercel Edge",icon:"⚡",code:"export default {\n  images:{domains:['cdn.store.ma']},\n  experimental:{ppr:true}\n}",course:"Slides 65–68"}]},
    {id:"api",label:"COUCHE API",color:C.green,nodes:[{id:"products_api",label:"API Produits",sub:"REST JSON",icon:"📦",code:"export async function GET() {\n  const {data} = await supabase\n    .from('products').select('*')\n    .eq('status','active')\n  return Response.json(data)\n}",course:"Slides 56"},{id:"auth_api",label:"Auth JWT",sub:"OAuth 2.0",icon:"🔐",code:"export function middleware(req) {\n  const token = req.cookies.get('session')\n  if (!token) return redirect('/login')\n  return verifyJWT(token)\n}",course:"Slides 74–78"},{id:"checkout_api",label:"Checkout",sub:"Stripe·CMI",icon:"💳",code:"const session = await stripe.checkout\n  .sessions.create({\n    line_items: cartItems,\n    mode: 'payment'\n  })",course:"Slides 80–84"}]},
    {id:"data",label:"COUCHE DONNÉES",color:C.xambr,nodes:[{id:"db",label:"PostgreSQL",sub:"Supabase RLS",icon:"🗄️",code:"CREATE TABLE products (\n  id UUID PRIMARY KEY,\n  name TEXT NOT NULL,\n  price NUMERIC(10,2),\n  stock INT DEFAULT 0\n);\nCREATE POLICY 'read' ON products\n  FOR SELECT USING (status='active');",course:"Slides 69"},{id:"cache",label:"Redis Cache",sub:"Sessions·KPIs",icon:"⚡",code:"await redis.setex(\n  `cart:${userId}`, 3600,\n  JSON.stringify(cartItems)\n)",course:"Slides 98"}]},
  ];
      ...
      <div style={{flex:1,overflowY:"auto",padding:"22px 26px"}}>
                ...
                <div key={c.id} onClick={()=>setActiveCarac(activeCarac?.id===c.id?null:c)}
                  ...
                  {activeCarac?.id===c.id&&(
                    <div style={{marginTop:12}}>
                      <div style={{fontFamily:"'Outfit',sans-serif",fontSize:10,color:C.xambr,fontWeight:600,marginBottom:5}}>🛍 NouaSell v4 :</div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:14}}>
              {REVENUE_MODELS.map(m=>(
                <div key={m.icon} style={{background:C.xs1,border:`1px solid ${m.color}33`,borderRadius:12,padding:"16px 18px",transition:"all .25s"}}
                  ...
                  <div style={{background:`${m.color}10`,border:`1px solid ${m.color}22`,borderRadius:6,padding:"6px 10px",fontFamily:"'Outfit',sans-serif",fontSize:11,color:C.xtext}}>{m.ex}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{overflowX:"auto"}}>
              <table style={{width:"100%",borderCollapse:"collapse",fontFamily:"'Outfit',sans-serif",fontSize:11}}>
                <thead><tr style={{background:C.xs1}}>{["Acteur","Modèle","Avantage","Limite","Part","Note"].map(h=><th key={h} style={{padding:"10px 12px",textAlign:"left",fontFamily:"'JetBrains Mono',monospace",fontSize:8,color:C.xdim,letterSpacing:"0.1em",borderBottom:`1px solid ${C.xb}`}}>{h.toUpperCase()}</th>)}</tr></thead>
                <tbody>{COMPETITORS.map(c=>(
                  <tr key={c.name} style={{borderBottom:`1px solid ${C.xb}44`,background:c.name==="NouaSell"?`${C.gold}08`:"transparent"}} onMouseEnter={e=>e.currentTarget.style.background=C.xs2} onMouseLeave={e=>e.currentTarget.style.background=c.name==="NouaSell"?`${C.gold}08`:"transparent"}>
                    ...
                    <td style={{padding:"10px 12px",color:C.xtext,fontSize:10,maxWidth:140}}>{c.force}</td>
                    <td style={{padding:"10px 12px",color:C.xsub,fontSize:10,maxWidth:130}}>{c.limite||"—"}</td>
        ...
        {view==="kpis"&&(
          <div>
            ...
            <div style={{fontFamily:"'Outfit',sans-serif",fontSize:11,color:C.xsub,marginBottom:18}}>Slides 98–112 · Formules + valeurs NouaSell</div>
...
export default function App() {
  ...
  const addToCart=useCallback((product,opts={})=>{
    ...
    const nm=product.name[lang]||product.name.fr;
    toast(`${nm} ajouté !`,"success","🛒");
  },[toast,lang]);
  ...
  const toggleWishlist=p=>{
    ...
    const nm=p.name[lang]||p.name.fr;
    toast(has?`${nm} retiré`:`${nm} ajouté aux favoris !`,has?"info":"success",has?"🤍":"❤️");
  };
  ...
  const MODES=[{id:"store",icon:"🛍",label:t("shop")},{id:"admin",icon:"⚙️",label:t("admin")},{id:"xray",icon:"◈",label:t("xray")}];
  const dir=lang==="ar"?"rtl":"ltr";
      ...
      <div style={{height:"100vh",display:"flex",flexDirection:"column",background:C.bg,overflow:"hidden"}} dir={dir}>
        ...
        <div style={{background:C.dark,borderBottom:`1px solid rgba(201,169,110,0.2)`,padding:"0 18px",display:"flex",alignItems:"center",gap:10,height:50,flexShrink:0,zIndex:100}}>
          ...
          <div style={{display:"flex",gap:2,background:"rgba(255,255,255,0.06)",borderRadius:8,padding:2,border:"1px solid rgba(255,255,255,0.1)"}}>
            {MODES.map(m=>(
              <button key={m.id} onClick={()=>{setMode("main");setStoreTab(m.id==="store"?"shop":m.id);}} style={{background:storeTab===m.id&&mode==="main"||m.id==="admin"&&storeTab==="admin"||m.id==="xray"&&storeTab==="xray"?"rgba(255,255,255,0.12)":"transparent",border:"1px solid transparent",borderRadius:6,padding:"4px 12px",color:C.cream,fontSize:11,cursor:"pointer",fontWeight:600,transition:"all .2s",fontFamily:"'Outfit',sans-serif",display:"flex",alignItems:"center",gap:4,opacity:0.8}}
